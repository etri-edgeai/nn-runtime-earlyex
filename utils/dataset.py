...
def get_dataset(cfg):
    ...
    if cfg['dataset'] == 'cifar10':
        ...
        trainset = torchvision.datasets.MNIST(cfg['dataset_path'], train=True, download=True, transform=transform)
        testset = torchvision.datasets.MNIST(cfg['dataset_path'], train=False, transform=transform)
